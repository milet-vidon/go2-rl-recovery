...
## CURRENT JOB — fresh action-reference pair

Updated 2026-09-16 15:53 local. A finite serial pair is RUNNING; do not launch another simulator. Each arm has 512 environments and 1,000 fresh PPO iterations (12,288,000 environment steps), followed by bank side/back, controlled-drop upright/30-degree and upright/45-degree evaluations. Both start from the identical untrained seed42 checkpoint; this is NOT an old model continued under silently changed controls.

- Orchestrator exec session **51917**, log `E:/IsaacLab/artifacts/recovery-20260916/target1000-orchestrator-retry.log`.
- First arm active: `E:/IsaacLab/repo/logs/rsl_rl/unitree_go2_recovery/2026-09-16_15-52-50_20260916-target1000_nominal`; log `E:/IsaacLab/artifacts/recovery-20260916/20260916-target1000-nominal-train.log`. Expected final `model_999.pt`. At15:53 it had98,304 environment steps and no runtime error. This is progress, not acceptance evidence.
- Second arm queued inside the SAME process, run suffix `20260916-target1000_current`. Do not launch it separately while the orchestrator is alive. It starts after the nominal arm's three evaluations.
- Launch: `scripts/run_recovery_action_ablation.ps1 -RunTag 20260916-target1000 -Iterations 1000`. Exact bootstrap/bank hashes are checked. Initial launcher parse failure occurred before training and was fixed; the retry log above is the active one.
