...
2026-09-16 19:02：已启动新的Smith-inspired奖励结构训练（128环境、2000轮），先翻正、接近正立后再奖励站起。动力学、动作、状态库与PPO保持不变；真实短测及配置检查通过，正式效果尚待训练后严格评估。不能把奖励上升或短测通过称作恢复成功。[本轮设计与边界](docs/smith-reward-pilot-20260916.md) · [运行状态](docs/training-status-20260916.md)。
