...
$copies = @()
foreach ($name in @('standard_env_cfg.py', 'robust_env_cfg.py', 'natural_env_cfg.py', 'natural_stop_env_cfg.py', 'natural_robust_env_cfg.py', 'recovery_env_cfg.py', 'recovery_mdp.py', 'recovery_math.py')) {
